...
async function sendRequestRejectMail({
  title,
  borrower_name,
  borrower_email,
  borrow_date,
  ...
  const mailOptions = {
    ...
    to: borrower_email,
    subject: `${request_type} rejected for ${title}`,
    template: "Reject_mail", // Updated template name
    context: {
      title,
      borrower_name,
      borrower_email,
    ...
    text: `The ${request_type} has been rejected!. Please contact the librarian for further details.\n\nBook Title: ${title}\nBorrower Name: ${borrower_name}\nBorrower Email: ${borrower_email}\nBorrow Date: ${borrow_date}\nReturn Date: ${return_date}\nRegister ID: ${register_id}`,
  };
...
module.exports = sendRequestRejectMail;
