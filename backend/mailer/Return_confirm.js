...
async function sendReturnConfirmMail({ title, borrower_name, borrower_email, borrow_date, return_date, register_id }) {
  const mailOptions = {
    from: {
      name: 'Library',
      address: offEmail
    ...
    to: borrower_email,
    subject: `Return Confirmation of the ${title} book`,
    ...
    text: `You have submitted the Book back to the library. So, Your Return has been Confirmed. Please contact the librarian for further details.\n\nBorrower Name: ${borrower_name}\nRegister ID: ${register_id}\nBook Title: ${title}\nBorrower Email: ${borrower_email}\nBorrow Date: ${borrow_date}\nReturn Date: ${return_date}`
  };
...
module.exports = sendReturnConfirmMail;
